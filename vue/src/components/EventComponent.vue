<template>
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="grade in Grades" :key="grade._id">
                        ...
                        <td>
                            <router-link :to="{name: 'editEvent', params: { id: grade._id }}" class="btn btn-success">Edit
                            </router-link>
            ...
            <button @click="isShow = !isShow" class="btn btn-primary mt-3" v-if="!isShow" >Add Event</button>
        </div>
    </div>
</template>
